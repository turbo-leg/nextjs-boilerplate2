  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 pb-12 sm:pb-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative">
        ...
        <header className="py-10 sm:py-16 md:py-24 text-center relative">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 leading-tight">
              NBA Player Stats
            </h1>
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-2xl mx-auto">
              Explore and compare career statistics for the top NBA players of all time
            </p>
            <Link 
              href="/compare" 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium py-2 sm:py-3 px-6 sm:px-8 rounded-xl transition-all shadow-md hover:shadow-lg transform hover:-translate-y-1 duration-300"
            >
        ...
        <div className="mb-8 sm:mb-12 bg-white/80 dark:bg-gray-800/80 p-4 sm:p-6 rounded-2xl shadow-lg backdrop-blur-sm border border-white/20 dark:border-gray-700/20">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Ranked by career points</div>
            </div>
          </div>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 xl:gap-8 mb-12 sm:mb-16">
        ...
        <footer className="mt-12 sm:mt-24 text-center">
          <div className="flex flex-col items-center justify-center gap-4">
            <div className="inline-flex items-center justify-center p-1 rounded-full bg-gray-100 dark:bg-gray-800/50 backdrop-blur-sm mb-6">
              <div className="flex flex-wrap gap-2 md:gap-6 items-center justify-center text-gray-600 dark:text-gray-400 px-4 sm:px-6 py-2">
                <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-xs sm:text-sm md:text-base">About</a>
                <span className="h-1 w-1 rounded-full bg-gray-400 dark:bg-gray-600 hidden sm:block"></span>
                <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-xs sm:text-sm md:text-base">Stats API</a>
                <span className="h-1 w-1 rounded-full bg-gray-400 dark:bg-gray-600 hidden sm:block"></span>
                <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-xs sm:text-sm md:text-base">Contact</a>
              </div>
            </div>
