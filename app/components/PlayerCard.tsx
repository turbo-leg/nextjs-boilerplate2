...
export default function PlayerCard({ player, imagePath }: { player: PlayerStat; imagePath: string }) {
  ...
  return (
    <div className="group flex flex-col items-center bg-white dark:bg-gray-900 rounded-2xl shadow-md overflow-hidden w-full max-w-sm border border-gray-100 dark:border-gray-800 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
      <div className="w-full h-80 relative bg-gray-200 dark:bg-gray-800 overflow-hidden">
        {isLoading && !imgError && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500 animate-spin"></div>
          </div>
        )}
      ...
      <div className="p-5 w-full">
        ...
        <div className="mt-5 text-center px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl">
